...
| RF-06 | Pagar pedido en línea | El estudiante puede pagar su pedido a través de una pasarela de pagos segura. | Estudiantes / Restaurantes | MUST | Dado que el estudiante confirma un pedido, cuando selecciona “Pagar en línea”, entonces el sistema procesa la transacción y actualiza el estado a “Pagado”. |
